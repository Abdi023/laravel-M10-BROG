    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('skills.create') }}" class="px-4 py-4 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">
                    New Skill
                </a>
            </div>
                    ...
                    <tbody>
                        @forelse ($skills as $skill)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                                ...
                                <td class="px-6 py-4">
                                    <img class="w-12 h-12" src="{{asset('storage/' . $skill->image)}}" alt=""/>
                                </td>
